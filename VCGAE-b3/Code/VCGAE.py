...
class LightGCN(object):
    def __init__(self, data_config, pretrain_data):
        ...
        pv_embeddings = self._create_pv_embed()
        ...
        cart_embeddings = self._create_cart_embed()
        if self.node_dropout_flag:
        ...
        buy_embeddings = self._create_lightgcn_embed()
        if self.node_dropout_flag:
        ...
        self.mu_u = self.ua_embeddings_buy
        self.mu_i = self.ia_embeddings_buy
